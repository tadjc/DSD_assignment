Two registers were used to stor address data with load control sognals. MUX is used to select a particular address and that address was passed to the decoder. <br>
